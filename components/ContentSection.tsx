  ...
  const steps = [
    {
      ...
      desc: "We audit your current site—structure, speed, technical SEO—to identify what's leaking revenue. Whether you're on WordPress, Shopify, or a custom build, we find the cracks. A solid foundation is non-negotiable."
    },
    {
      title: "2. Optimize for conversions",
      desc: "We implement clear calls-to-action, remove distractions, and design user flows that guide visitors toward booking, buying, or contacting you—whatever your business needs."
    },
    {
    ...
    },
    {
      ...
      desc: "Stop copy-pasting leads into spreadsheets. We integrate your forms with your CRM, email platform, or booking system so inquiries flow automatically—whether you're closing contracts or taking dinner reservations."
    },
    {
      title: "5. Measure real ROI",
      desc: "We track actual business outcomes—form fills, phone calls, online orders, bookings—so you know exactly how much revenue your website is generating, not just vanity metrics like 'page views.'"
    }
  ];
