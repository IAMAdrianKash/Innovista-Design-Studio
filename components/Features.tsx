  ...
  const features = [
    {
      ...
      desc: "Restaurants, retail shops, salons, and home service providers. We build websites that capture local search traffic and turn visitors into walk-ins or bookings.",
      image: "https://images.unsplash.com/photo-1497215728101-856f4ea42174?q=80&w=2070&auto=format&fit=crop"
    },
    {
      icon: <HardHat size={32} strokeWidth={1.5} />,
      title: "Professional Services",
      desc: "Law, accounting, consulting, and financial services. We position you as the expert and build trust through clear messaging and strategic design.",
    ...
    },
    {
      ...
      desc: "Online stores and hybrid businesses that need seamless shopping experiences. We build on Shopify, WooCommerce, or custom platforms—whatever fits your catalog and goals.",
      image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=2070&auto=format&fit=crop"
    }
  ];
        ...
        >
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-[#595959] max-w-xl leading-relaxed">
              From restaurants to law firms to industrial operations. We build websites for Alberta businesses where trust, credibility, and conversions matter.
            </p>
          </div>
