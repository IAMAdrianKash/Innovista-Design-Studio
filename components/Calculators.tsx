        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              We stripped away the agency fluff. No account managers, no hidden fees, no hostages. Just high-end execution.
            </p>
          </motion.div>
          ...
          >
             <div>
                ...
                <p className="text-gray-500 text-sm leading-relaxed">
                  Projects start at $8k. No hidden fees, no surprise invoices. You know exactly what you're paying for.
                </p>
             </div>
          </motion.div>
          ...
          >
            <div className="relative z-10">
              ...
              <p className="text-gray-400 max-w-md leading-relaxed">
                We use React, Next.js, and Sanity. Not slow WordPress plugins held together with duct tape. Your site will be faster and more secure than your competitors.
              </p>
            </div>
